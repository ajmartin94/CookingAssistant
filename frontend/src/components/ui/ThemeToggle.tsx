 ...
 * Uses sun/moon icons to indicate current theme state.
 */

import { useTheme } from '../../contexts/ThemeContext';

// Sun icon for light mode (shows when in dark mode to indicate "switch to light")
const SunIcon = () => (
  <svg
    width="20"
    height="20"
...
// Moon icon for dark mode (shows when in light mode to indicate "switch to dark")
const MoonIcon = () => (
  <svg
    width="20"
    height="20"
