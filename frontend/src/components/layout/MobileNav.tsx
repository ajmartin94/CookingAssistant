...
export default function MobileNav({ isOpen, onClose }: MobileNavProps) {
  ...
  const linkBaseClasses = 'flex items-center gap-3 px-4 py-3 text-lg';
  const activeLinkClasses = 'bg-primary-100 text-primary-700';
  const inactiveLinkClasses = 'text-neutral-700 hover:bg-neutral-100';
  ...
  return (
    <>
      ...
      {/* Slide-out menu */}
      <div className="fixed inset-y-0 left-0 w-72 bg-white shadow-soft-xl z-50 lg:hidden">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-neutral-200">
          <span className="text-xl font-bold text-primary-500">Cooking Assistant</span>
          <button
            onClick={onClose}
