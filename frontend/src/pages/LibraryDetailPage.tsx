            ...
            <form onSubmit={handleUpdate}>
              ...
              <div className="mb-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-gray-700">Public library</span>
                </label>
              </div>
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-4 py-2 border border-orange-600 text-orange-600 rounded-lg font-medium hover:bg-orange-50 transition"
                  >
                    Share
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="px-4 py-2 border border-red-300 rounded-lg font-medium text-red-600 hover:bg-red-50 transition"
                  >
                    Delete
                  </button>
                </div>
